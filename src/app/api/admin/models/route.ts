  ...
  try {
    ...
    return NextResponse.json({
      ...
      models: models.map((model) => ({
        ...
        costPer1kInputTokens: model.costPer1kInputTokens ? Number(model.costPer1kInputTokens) : undefined,
        costPer1kOutputTokens: model.costPer1kOutputTokens ? Number(model.costPer1kOutputTokens) : undefined,
        maxTokens: model.maxTokens,
        temperature: model.temperature ? Number(model.temperature) : 0.7,
